...
class AcceptedTasks extends StatefulWidget {
  AcceptedTasks({Key key}) : super(key: key);

  @override
  _AcceptedTasksState createState() => _AcceptedTasksState();
}
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        Container(
                          child: Text(
                            'Created by : ${document['UserNickname']}',
                            // style: TextStyle(color: primaryColor),
                          ),
                          alignment: Alignment.centerLeft,
                          margin: EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 0.0),
                        ),
                      Image.network(document['UserPhoto']),
                    ],
                  ),
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  if (snapshot.data.documents[index]['AssignedUser'] == id) {
                    // print(index);
                          ...
                          Row(
                            children: <Widget>[
                              FlatButton.icon(
                                ...
                                label: new Text("Give up on helping",
